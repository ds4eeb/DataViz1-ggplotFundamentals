...
1.  A Quarto document with all of your R code that has been rendered to PDF. Please include all of the code that appears in this document, in addition to adding your own code in the "Q#" sections.
